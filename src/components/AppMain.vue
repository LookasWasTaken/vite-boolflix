        ...
        <div class="container">
            ...
            <ul class="row row-cols-2 row-cols-md-3 row-cols-lg-5 g-3" v-if="store.movies.length > 0">
                <li class="col" v-for="(movie, index) in store.movies">
                    ...
                    <p>Language: <country-flag :country="setLanguage(movie.original_language)"
                            size='normal' :rounded="true" :shadow="true" /></p>
                    <p class="d-flex align-items-center mb-0">Score:
            ...
            <ul class="row row-cols-2 row-cols-md-3 row-cols-lg-5 g-3" v-if="store.series.length > 0">
                <li class="col" v-for="(serie, index) in store.series">
                    ...
                    <p>Language: <country-flag :country="setLanguage(serie.original_language)"
                            size='normal' :rounded="true" :shadow="true" /></p>
                    <p class="d-flex align-items-center">Score:
